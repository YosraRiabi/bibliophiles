...
public class MailService {
    ...
    public MailService(JavaMailSender javaMailSender, SpringTemplateEngine
            templateEngine) {
    ...
    public void sendEmail(String to, String subject, String content, boolean
        ...
        try {
            ...
            message.setTo(to);
            message.setFrom("noreply@bibliophile.com");
    ...
    public void sendActivationEmail(User user) {
        ...
        sendEmailFromTemplate(user, "email/activation", "Bibliophile User Activation");
    }
    @Async
    public void sendWelcomeEmail(User user) {
        log.debug("Sending activation email to '{}'", user.getEmail());
        sendEmailFromTemplate(user, "email/welcome", "Welcome new Bibliophile User");
    }
}
